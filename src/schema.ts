...
/** ==== Common regex (export for reuse / tests) ==== */
...
/** ==== Reusable primitive schemas (branded) ==== */
...
/** ==== Event flag ==== */
export const EventFlagSchema = z
    .object({
        enabled: z.boolean(),
    })
    .strict();
...
/** ==== eventSettings: map<eventType, {enabled:boolean}> (min 1) ==== */
...
/** ==== POST /preferences body ==== */
export const PreferenceBodySchema = z
    .object({
        dnd: DndSchema.nullable().optional(), // null or omitted
        eventSettings: EventSettingsSchema,
    })
    .strict();
export type PreferenceBody = z.infer<typeof PreferenceBodySchema>;
export type PreferenceRequestBody = PreferenceBody; // alias (import kolaylığı)
...
export const EventPayloadSchema = z
    .object({
        ...
        // Trim + key şemasına daraltma → EventTypeKey
